...
;------------------------------------------------------------
;MUTATION TYPE: DATASET TO KILL JOIN MUTATIONS 
;------------------------------------------------------------
...
;------------------------------------------------------------
;DataSet Generated By Nulling: TEACHES1.ID
...
;------------------------------------------------------------
 ...
 (assert  (and (not (= (teaches_ID0 (select O_teaches 1)) (instructor_ID0 (select O_instructor 1))))	)) 
