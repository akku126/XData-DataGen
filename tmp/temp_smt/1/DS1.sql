...
insert into department values ('Physics','Taylor','50000.0')
insert into department values ('Finance','Taylor','50000.0')
insert into department values ('Music','Taylor','50000.0')
insert into instructor values ('10101','Einstein','Finance',null)
