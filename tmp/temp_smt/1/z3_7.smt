...
;------------------------------------------------------------
;MUTATION TYPE: DATASET TO KILL DISTINCT MUTATIONS IN WHERE CLAUSE NESTED SUB QUERY BLOCK
;------------------------------------------------------------
...
(assert (or (= (teaches_ID0 (select O_teaches 3))
       (instructor_ID0 (select O_instructor 4)))))
...
(assert (or (= (teaches_COURSE_ID1 (select O_teaches 3))
       (section_COURSE_ID0 (select O_section 3)))))

(assert (or (= (teaches_SEC_ID2 (select O_teaches 3))
       (section_SEC_ID1 (select O_section 3)))))

(assert (or (= (teaches_SEMESTER3 (select O_teaches 3))
       (section_SEMESTER2 (select O_section 3)))))

(assert (or (= (teaches_YEAR4 (select O_teaches 3))
       (section_YEAR3 (select O_section 3)))))
(assert (or (= (teaches_COURSE_ID1 (select O_teaches 1))
...
(assert (or (= (section_BUILDING4 (select O_section 3))
       (classroom_BUILDING0 (select O_classroom 3)))
    (ISNULL_BUILDING (section_BUILDING4 (select O_section 3)))))

(assert (or (= (section_ROOM_NUMBER5 (select O_section 3))
       (classroom_ROOM_NUMBER1 (select O_classroom 3)))
    (ISNULL_ROOM_NUMBER (section_ROOM_NUMBER5 (select O_section 3)))))
...
(assert (or (= (section_COURSE_ID0 (select O_section 2))
       (course_COURSE_ID0 (select O_course 5)))))

(assert (or (= (section_COURSE_ID0 (select O_section 3))
       (course_COURSE_ID0 (select O_course 6)))))
...
(assert (or (= (course_DEPT_NAME2 (select O_course 5))
       (department_DEPT_NAME0 (select O_department 5)))
    (ISNULL_DEPT_NAME (course_DEPT_NAME2 (select O_course 5)))))

(assert (or (= (course_DEPT_NAME2 (select O_course 6))
       (department_DEPT_NAME0 (select O_department 6)))
    (ISNULL_DEPT_NAME (course_DEPT_NAME2 (select O_course 6)))))
...
(assert (or (= (instructor_DEPT_NAME2 (select O_instructor 2))
       (department_DEPT_NAME0 (select O_department 8)))
    (ISNULL_DEPT_NAME (instructor_DEPT_NAME2 (select O_instructor 2)))))

(assert (or (= (instructor_DEPT_NAME2 (select O_instructor 3))
       (department_DEPT_NAME0 (select O_department 9)))
    (ISNULL_DEPT_NAME (instructor_DEPT_NAME2 (select O_instructor 3)))))

(assert (or (= (instructor_DEPT_NAME2 (select O_instructor 4))
       (department_DEPT_NAME0 (select O_department 10)))
    (ISNULL_DEPT_NAME (instructor_DEPT_NAME2 (select O_instructor 4)))))
...
(assert (=> (= (instructor_ID0 (select O_instructor 1))(instructor_ID0 (select O_instructor 4)) )(and (= (instructor_NAME1 (select O_instructor 1))(instructor_NAME1 (select O_instructor 4)) )(= (instructor_DEPT_NAME2 (select O_instructor 1))(instructor_DEPT_NAME2 (select O_instructor 4)) )(= (instructor_SALARY3 (select O_instructor 1))(instructor_SALARY3 (select O_instructor 4)) )) )) 
...
(assert (=> (= (instructor_ID0 (select O_instructor 2))(instructor_ID0 (select O_instructor 4)) )(and (= (instructor_NAME1 (select O_instructor 2))(instructor_NAME1 (select O_instructor 4)) )(= (instructor_DEPT_NAME2 (select O_instructor 2))(instructor_DEPT_NAME2 (select O_instructor 4)) )(= (instructor_SALARY3 (select O_instructor 2))(instructor_SALARY3 (select O_instructor 4)) )) )) 

(assert (=> (= (instructor_ID0 (select O_instructor 3))(instructor_ID0 (select O_instructor 4)) )(and (= (instructor_NAME1 (select O_instructor 3))(instructor_NAME1 (select O_instructor 4)) )(= (instructor_DEPT_NAME2 (select O_instructor 3))(instructor_DEPT_NAME2 (select O_instructor 4)) )(= (instructor_SALARY3 (select O_instructor 3))(instructor_SALARY3 (select O_instructor 4)) )) )) 
...
(assert (=> (and (= (teaches_ID0 (select O_teaches 1))(teaches_ID0 (select O_teaches 3)) )(= (teaches_COURSE_ID1 (select O_teaches 1))(teaches_COURSE_ID1 (select O_teaches 3)) )(= (teaches_SEC_ID2 (select O_teaches 1))(teaches_SEC_ID2 (select O_teaches 3)) )(= (teaches_SEMESTER3 (select O_teaches 1))(teaches_SEMESTER3 (select O_teaches 3)) )(= (teaches_YEAR4 (select O_teaches 1))(teaches_YEAR4 (select O_teaches 3)) ) ) true )) 

(assert (=> (and (= (teaches_ID0 (select O_teaches 2))(teaches_ID0 (select O_teaches 3)) )(= (teaches_COURSE_ID1 (select O_teaches 2))(teaches_COURSE_ID1 (select O_teaches 3)) )(= (teaches_SEC_ID2 (select O_teaches 2))(teaches_SEC_ID2 (select O_teaches 3)) )(= (teaches_SEMESTER3 (select O_teaches 2))(teaches_SEMESTER3 (select O_teaches 3)) )(= (teaches_YEAR4 (select O_teaches 2))(teaches_YEAR4 (select O_teaches 3)) ) ) true )) 
...
(assert (=> (= (department_DEPT_NAME0 (select O_department 1))(department_DEPT_NAME0 (select O_department 8)) )(and (= (department_BUILDING1 (select O_department 1))(department_BUILDING1 (select O_department 8)) )(= (department_BUDGET2 (select O_department 1))(department_BUDGET2 (select O_department 8)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 1))(department_DEPT_NAME0 (select O_department 9)) )(and (= (department_BUILDING1 (select O_department 1))(department_BUILDING1 (select O_department 9)) )(= (department_BUDGET2 (select O_department 1))(department_BUDGET2 (select O_department 9)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 1))(department_DEPT_NAME0 (select O_department 10)) )(and (= (department_BUILDING1 (select O_department 1))(department_BUILDING1 (select O_department 10)) )(= (department_BUDGET2 (select O_department 1))(department_BUDGET2 (select O_department 10)) )) )) 
...
(assert (=> (= (department_DEPT_NAME0 (select O_department 2))(department_DEPT_NAME0 (select O_department 8)) )(and (= (department_BUILDING1 (select O_department 2))(department_BUILDING1 (select O_department 8)) )(= (department_BUDGET2 (select O_department 2))(department_BUDGET2 (select O_department 8)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 2))(department_DEPT_NAME0 (select O_department 9)) )(and (= (department_BUILDING1 (select O_department 2))(department_BUILDING1 (select O_department 9)) )(= (department_BUDGET2 (select O_department 2))(department_BUDGET2 (select O_department 9)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 2))(department_DEPT_NAME0 (select O_department 10)) )(and (= (department_BUILDING1 (select O_department 2))(department_BUILDING1 (select O_department 10)) )(= (department_BUDGET2 (select O_department 2))(department_BUDGET2 (select O_department 10)) )) )) 
...
(assert (=> (= (department_DEPT_NAME0 (select O_department 3))(department_DEPT_NAME0 (select O_department 8)) )(and (= (department_BUILDING1 (select O_department 3))(department_BUILDING1 (select O_department 8)) )(= (department_BUDGET2 (select O_department 3))(department_BUDGET2 (select O_department 8)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 3))(department_DEPT_NAME0 (select O_department 9)) )(and (= (department_BUILDING1 (select O_department 3))(department_BUILDING1 (select O_department 9)) )(= (department_BUDGET2 (select O_department 3))(department_BUDGET2 (select O_department 9)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 3))(department_DEPT_NAME0 (select O_department 10)) )(and (= (department_BUILDING1 (select O_department 3))(department_BUILDING1 (select O_department 10)) )(= (department_BUDGET2 (select O_department 3))(department_BUDGET2 (select O_department 10)) )) )) 
...
(assert (=> (= (department_DEPT_NAME0 (select O_department 4))(department_DEPT_NAME0 (select O_department 8)) )(and (= (department_BUILDING1 (select O_department 4))(department_BUILDING1 (select O_department 8)) )(= (department_BUDGET2 (select O_department 4))(department_BUDGET2 (select O_department 8)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 4))(department_DEPT_NAME0 (select O_department 9)) )(and (= (department_BUILDING1 (select O_department 4))(department_BUILDING1 (select O_department 9)) )(= (department_BUDGET2 (select O_department 4))(department_BUDGET2 (select O_department 9)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 4))(department_DEPT_NAME0 (select O_department 10)) )(and (= (department_BUILDING1 (select O_department 4))(department_BUILDING1 (select O_department 10)) )(= (department_BUDGET2 (select O_department 4))(department_BUDGET2 (select O_department 10)) )) )) 
...
(assert (=> (= (department_DEPT_NAME0 (select O_department 5))(department_DEPT_NAME0 (select O_department 8)) )(and (= (department_BUILDING1 (select O_department 5))(department_BUILDING1 (select O_department 8)) )(= (department_BUDGET2 (select O_department 5))(department_BUDGET2 (select O_department 8)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 5))(department_DEPT_NAME0 (select O_department 9)) )(and (= (department_BUILDING1 (select O_department 5))(department_BUILDING1 (select O_department 9)) )(= (department_BUDGET2 (select O_department 5))(department_BUDGET2 (select O_department 9)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 5))(department_DEPT_NAME0 (select O_department 10)) )(and (= (department_BUILDING1 (select O_department 5))(department_BUILDING1 (select O_department 10)) )(= (department_BUDGET2 (select O_department 5))(department_BUDGET2 (select O_department 10)) )) )) 
...
(assert (=> (= (department_DEPT_NAME0 (select O_department 6))(department_DEPT_NAME0 (select O_department 8)) )(and (= (department_BUILDING1 (select O_department 6))(department_BUILDING1 (select O_department 8)) )(= (department_BUDGET2 (select O_department 6))(department_BUDGET2 (select O_department 8)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 6))(department_DEPT_NAME0 (select O_department 9)) )(and (= (department_BUILDING1 (select O_department 6))(department_BUILDING1 (select O_department 9)) )(= (department_BUDGET2 (select O_department 6))(department_BUDGET2 (select O_department 9)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 6))(department_DEPT_NAME0 (select O_department 10)) )(and (= (department_BUILDING1 (select O_department 6))(department_BUILDING1 (select O_department 10)) )(= (department_BUDGET2 (select O_department 6))(department_BUDGET2 (select O_department 10)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 7))(department_DEPT_NAME0 (select O_department 8)) )(and (= (department_BUILDING1 (select O_department 7))(department_BUILDING1 (select O_department 8)) )(= (department_BUDGET2 (select O_department 7))(department_BUDGET2 (select O_department 8)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 7))(department_DEPT_NAME0 (select O_department 9)) )(and (= (department_BUILDING1 (select O_department 7))(department_BUILDING1 (select O_department 9)) )(= (department_BUDGET2 (select O_department 7))(department_BUDGET2 (select O_department 9)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 7))(department_DEPT_NAME0 (select O_department 10)) )(and (= (department_BUILDING1 (select O_department 7))(department_BUILDING1 (select O_department 10)) )(= (department_BUDGET2 (select O_department 7))(department_BUDGET2 (select O_department 10)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 8))(department_DEPT_NAME0 (select O_department 9)) )(and (= (department_BUILDING1 (select O_department 8))(department_BUILDING1 (select O_department 9)) )(= (department_BUDGET2 (select O_department 8))(department_BUDGET2 (select O_department 9)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 8))(department_DEPT_NAME0 (select O_department 10)) )(and (= (department_BUILDING1 (select O_department 8))(department_BUILDING1 (select O_department 10)) )(= (department_BUDGET2 (select O_department 8))(department_BUDGET2 (select O_department 10)) )) )) 

(assert (=> (= (department_DEPT_NAME0 (select O_department 9))(department_DEPT_NAME0 (select O_department 10)) )(and (= (department_BUILDING1 (select O_department 9))(department_BUILDING1 (select O_department 10)) )(= (department_BUDGET2 (select O_department 9))(department_BUDGET2 (select O_department 10)) )) )) 
...
(assert (=> (and (= (section_COURSE_ID0 (select O_section 1))(section_COURSE_ID0 (select O_section 3)) )(= (section_SEC_ID1 (select O_section 1))(section_SEC_ID1 (select O_section 3)) )(= (section_SEMESTER2 (select O_section 1))(section_SEMESTER2 (select O_section 3)) )(= (section_YEAR3 (select O_section 1))(section_YEAR3 (select O_section 3)) ) ) (and (= (section_BUILDING4 (select O_section 1))(section_BUILDING4 (select O_section 3)) )(= (section_ROOM_NUMBER5 (select O_section 1))(section_ROOM_NUMBER5 (select O_section 3)) )(= (section_TIME_SLOT_ID6 (select O_section 1))(section_TIME_SLOT_ID6 (select O_section 3)) )) )) 

(assert (=> (and (= (section_COURSE_ID0 (select O_section 2))(section_COURSE_ID0 (select O_section 3)) )(= (section_SEC_ID1 (select O_section 2))(section_SEC_ID1 (select O_section 3)) )(= (section_SEMESTER2 (select O_section 2))(section_SEMESTER2 (select O_section 3)) )(= (section_YEAR3 (select O_section 2))(section_YEAR3 (select O_section 3)) ) ) (and (= (section_BUILDING4 (select O_section 2))(section_BUILDING4 (select O_section 3)) )(= (section_ROOM_NUMBER5 (select O_section 2))(section_ROOM_NUMBER5 (select O_section 3)) )(= (section_TIME_SLOT_ID6 (select O_section 2))(section_TIME_SLOT_ID6 (select O_section 3)) )) )) 
...
(assert (=> (= (course_COURSE_ID0 (select O_course 1))(course_COURSE_ID0 (select O_course 5)) )(and (= (course_TITLE1 (select O_course 1))(course_TITLE1 (select O_course 5)) )(= (course_DEPT_NAME2 (select O_course 1))(course_DEPT_NAME2 (select O_course 5)) )(= (course_CREDITS3 (select O_course 1))(course_CREDITS3 (select O_course 5)) )) )) 

(assert (=> (= (course_COURSE_ID0 (select O_course 1))(course_COURSE_ID0 (select O_course 6)) )(and (= (course_TITLE1 (select O_course 1))(course_TITLE1 (select O_course 6)) )(= (course_DEPT_NAME2 (select O_course 1))(course_DEPT_NAME2 (select O_course 6)) )(= (course_CREDITS3 (select O_course 1))(course_CREDITS3 (select O_course 6)) )) )) 
...
(assert (=> (= (course_COURSE_ID0 (select O_course 2))(course_COURSE_ID0 (select O_course 5)) )(and (= (course_TITLE1 (select O_course 2))(course_TITLE1 (select O_course 5)) )(= (course_DEPT_NAME2 (select O_course 2))(course_DEPT_NAME2 (select O_course 5)) )(= (course_CREDITS3 (select O_course 2))(course_CREDITS3 (select O_course 5)) )) )) 

(assert (=> (= (course_COURSE_ID0 (select O_course 2))(course_COURSE_ID0 (select O_course 6)) )(and (= (course_TITLE1 (select O_course 2))(course_TITLE1 (select O_course 6)) )(= (course_DEPT_NAME2 (select O_course 2))(course_DEPT_NAME2 (select O_course 6)) )(= (course_CREDITS3 (select O_course 2))(course_CREDITS3 (select O_course 6)) )) )) 
...
(assert (=> (= (course_COURSE_ID0 (select O_course 3))(course_COURSE_ID0 (select O_course 5)) )(and (= (course_TITLE1 (select O_course 3))(course_TITLE1 (select O_course 5)) )(= (course_DEPT_NAME2 (select O_course 3))(course_DEPT_NAME2 (select O_course 5)) )(= (course_CREDITS3 (select O_course 3))(course_CREDITS3 (select O_course 5)) )) )) 

(assert (=> (= (course_COURSE_ID0 (select O_course 3))(course_COURSE_ID0 (select O_course 6)) )(and (= (course_TITLE1 (select O_course 3))(course_TITLE1 (select O_course 6)) )(= (course_DEPT_NAME2 (select O_course 3))(course_DEPT_NAME2 (select O_course 6)) )(= (course_CREDITS3 (select O_course 3))(course_CREDITS3 (select O_course 6)) )) )) 

(assert (=> (= (course_COURSE_ID0 (select O_course 4))(course_COURSE_ID0 (select O_course 5)) )(and (= (course_TITLE1 (select O_course 4))(course_TITLE1 (select O_course 5)) )(= (course_DEPT_NAME2 (select O_course 4))(course_DEPT_NAME2 (select O_course 5)) )(= (course_CREDITS3 (select O_course 4))(course_CREDITS3 (select O_course 5)) )) )) 

(assert (=> (= (course_COURSE_ID0 (select O_course 4))(course_COURSE_ID0 (select O_course 6)) )(and (= (course_TITLE1 (select O_course 4))(course_TITLE1 (select O_course 6)) )(= (course_DEPT_NAME2 (select O_course 4))(course_DEPT_NAME2 (select O_course 6)) )(= (course_CREDITS3 (select O_course 4))(course_CREDITS3 (select O_course 6)) )) )) 

(assert (=> (= (course_COURSE_ID0 (select O_course 5))(course_COURSE_ID0 (select O_course 6)) )(and (= (course_TITLE1 (select O_course 5))(course_TITLE1 (select O_course 6)) )(= (course_DEPT_NAME2 (select O_course 5))(course_DEPT_NAME2 (select O_course 6)) )(= (course_CREDITS3 (select O_course 5))(course_CREDITS3 (select O_course 6)) )) )) 
...
(assert (=> (and (= (classroom_BUILDING0 (select O_classroom 1))(classroom_BUILDING0 (select O_classroom 3)) )(= (classroom_ROOM_NUMBER1 (select O_classroom 1))(classroom_ROOM_NUMBER1 (select O_classroom 3)) ) ) (and (= (classroom_CAPACITY2 (select O_classroom 1))(classroom_CAPACITY2 (select O_classroom 3)) )) )) 

(assert (=> (and (= (classroom_BUILDING0 (select O_classroom 2))(classroom_BUILDING0 (select O_classroom 3)) )(= (classroom_ROOM_NUMBER1 (select O_classroom 2))(classroom_ROOM_NUMBER1 (select O_classroom 3)) ) ) (and (= (classroom_CAPACITY2 (select O_classroom 2))(classroom_CAPACITY2 (select O_classroom 3)) )) )) 
...
(assert (=  (instructor_ID0 (select O_instructor 1))  (teaches_ID0 (select O_teaches 2))  )) 
...
(assert ( =  (teaches_ID0 (select O_teaches 1)) (teaches_ID0 (select O_teaches 2)))) 
(assert ( =  (teaches_COURSE_ID1 (select O_teaches 1)) (teaches_COURSE_ID1 (select O_teaches 2)))) 
(assert ( =  (teaches_SEC_ID2 (select O_teaches 1)) (teaches_SEC_ID2 (select O_teaches 2)))) 
(assert ( =  (teaches_SEMESTER3 (select O_teaches 1)) (teaches_SEMESTER3 (select O_teaches 2)))) 
(assert ( =  (teaches_YEAR4 (select O_teaches 1)) (teaches_YEAR4 (select O_teaches 2)))) 
